...
<body>
    <div>
        ...
        <?php
            //exercicio 2 
        //$atual =$_GET["aa"];
        //echo"O ano Atuala é $atual e o ano //anteiror é ".--$atual;
        
        //exercicio 3
        //& esse simbolo referencia a variavel
//        $a=3;
//        $b=&$a;
//        $b+=5;
...
//        
        $x="abc";
        $$x="def";
        echo "O conetudo da variavel X e $x";
...
?php /* Esse comentário vai ocupar várias linhas do seu código e todas serão ignoradas */ $a += 1; // Esse é um comentário de uma linha
